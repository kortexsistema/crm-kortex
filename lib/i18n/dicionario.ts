...
export const DICIONARIO: Traducoes = {
  "Conta em Análise": { es: "Cuenta en Análisis" },
  "Seu cadastro foi recebido com sucesso. Por questões de segurança, novas contas passam por uma rápida análise antes da liberação total da plataforma. Entraremos em contato assim que o acesso for aprovado.": { es: "Su registro fue recibido con éxito. Por motivos de seguridad, las cuentas nuevas pasan por un análisis rápido antes de la liberación total de la plataforma. Nos pondremos en contacto en cuanto se apruebe el acceso." },
  "Falar com o atendimento via WhatsApp": { es: "Hablar con atención al cliente vía WhatsApp" },
  "Dúvidas? Escreva para": { es: "¿Dudas? Escriba a" },
  "Voltar para o login": { es: "Volver al inicio de sesión" },
  "Assinatura expirada": { es: "Suscripción expirada" },
  "O período de vigência da sua assinatura terminou. Para reativar o acesso imediatamente, realize o pagamento via PIX e envie o comprovante pelo WhatsApp.": { es: "El período de vigencia de su suscripción ha terminado. Para reactivar el acceso de inmediato, realice el pago vía PIX y envíe el comprobante por WhatsApp." },
  "Sua conta está temporariamente suspensa pelo administrador da plataforma. Entre em contato para saber o motivo e regularizar o acesso.": { es: "Su cuenta está suspendida temporalmente por el administrador de la plataforma. Póngase en contacto para conocer el motivo y regularizar el acceso." },
  "Chave PIX para renovação": { es: "Clave PIX para renovación" },
  "Enviar comprovante via WhatsApp": { es: "Enviar comprobante vía WhatsApp" },
  "Catálogos sincronizados com sucesso!": { es: "¡Catálogos sincronizados con éxito!" },
  "Erro ao sincronizar catálogos.": { es: "Error al sincronizar catálogos." },
  "Falha ao se comunicar com os provedores.": { es: "Fallo al comunicarse con los proveedores." },
  "Por favor, insira uma chave de API válida para o provedor.": { es: "Por favor, introduzca una clave de API válida para el proveedor." },
  "Nenhuma alteração de chave digitada para este provedor.": { es: "Ningún cambio de clave introducido para este proveedor." },
  "Falha ao salvar credencial.": { es: "Fallo al guardar la credencial." },
  "Credencial salva e validada com sucesso!": { es: "¡Credencial guardada y validada con éxito!" },
  "modelos identificados": { es: "modelos identificados" },
  "Erro inesperado ao salvar.": { es: "Error inesperado al guardar." },
  "Para alterar o status, confirme informando a nova chave ou salvando as alterações.": { es: "Para cambiar el estado, confirme introduciendo la nueva clave o guardando los cambios." },
  "Tem certeza que deseja remover a credencial deste provedor da plataforma?": { es: "¿Está seguro de que desea eliminar la credencial de este proveedor de la plataforma?" },
  "Falha ao remover credencial.": { es: "Fallo al eliminar credencial." },
  "Credencial removida com sucesso.": { es: "Credencial eliminada con éxito." },
  "Erro inesperado ao remover.": { es: "Error inesperado al eliminar." },
  "Provedores de Inteligência Artificial": { es: "Proveedores de Inteligencia Artificial" },
  "Configure as chaves de API globais dos provedores de IA para toda a plataforma SaaS. As credenciais configuradas aqui serão utilizadas automaticamente por todos os assinantes e agentes, eliminando a necessidade de cada cliente cadastrar suas próprias chaves.": { es: "Configure las claves de API globales de los proveedores de IA para toda la plataforma SaaS. Las credenciales configuradas aquí serán utilizadas automáticamente por todos los suscriptores y agentes, eliminando la necesidad de que cada cliente registre sus propias claves." },
  "Sincronizando...": { es: "Sincronizando..." },
  "Sincronizar Todos os Modelos": { es: "Sincronizar Todos los Modelos" },
  "Ativa na Plataforma": { es: "Activa en la Plataforma" },
  "Ativa via .env (Fallback)": { es: "Activa vía .env (Fallback)" },
  "Não configurada": { es: "No configurada" },
  "Erro de validação": { es: "Error de validación" },
  "Substituir Chave de API": { es: "Reemplazar Clave de API" },
  "Chave de API do Provedor": { es: "Clave de API del Proveedor" },
  "Obter chave no painel": { es: "Obtener clave en el panel" },
  "Chave salva com criptografia militar AES-256-GCM. Digite apenas se desejar substituí-la.": { es: "Clave guardada con cifrado militar AES-256-GCM. Introdúzcala solo si desea reemplazarla." },
  "A chave será testada e salva criptografada. Nunca é exposta na interface nem para assinantes.": { es: "La clave se probará y se guardará cifrada. Nunca se expone en la interfaz ni para los suscriptores." },
  "Modelos ativos detectados": { es: "Modelos activos detectados" },
  "Validando e Salvando...": { es: "Validando y Guardando..." },
  "Validar e Salvar": { es: "Validar y Guardar" },
  "Padrão da plataforma / instalação": { es: "Estándar de la plataforma / instalación" },
  "IA inclusa no plano SaaS": { es: "IA incluida en el plan SaaS" },
  "Esta instalação já disponibiliza provedores de inteligência artificial centralizados pelo Administrador Master. Seus agentes podem utilizar esses modelos nativamente sem necessidade de configurar chaves. Caso sua empresa prefira utilizar chaves de API próprias e dedicadas (BYOK), cadastre-as abaixo.": { es: "Esta instalación ya ofrece proveedores de inteligencia artificial centralizados por el Administrador Master. Sus agentes pueden usar estos modelos de forma nativa sin necesidad de configurar claves. Si su empresa prefiere usar claves de API propias y dedicadas (BYOK), regístrelas a continuación." },
  "Expirada": { es: "Expirada" },
  "Vence em breve": { es: "Vence pronto" },
  "Assinatura e Cobrança": { es: "Suscripción y Cobro" },
  "Gerenciamento do plano corporativo e renovação manual da sua organização.": { es: "Gestión del plan corporativo y renovación manual de su organización." },
  "Plano Vigente": { es: "Plan Vigente" },
  "Vencimento da Assinatura": { es: "Vencimiento de la Suscripción" },
  "Vitalício / Indeterminado": { es: "Vitalicio / Indeterminado" },
  "Período Restante": { es: "Período Restante" },
  "Expirado": { es: "Expirado" },
  "A renovação deste plano é realizada diretamente com o administrador da sua instalação.": { es: "La renovación de este plan se realiza directamente con el administrador de su instalación." },
  "Conecte um token de acesso para o sistema ler o desempenho das suas campanhas e mostrá-lo em Análise.": { es: "Conecte un token de acceso para que el sistema lea el rendimiento de sus campañas y lo muestre en Análisis." },

  "Renovação Manual via PIX": { es: "Renovación Manual vía PIX" },
  "Chave PIX oficial:": { es: "Clave PIX oficial:" },
  "Chave PIX não cadastrada nas configurações da plataforma.": { es: "Clave PIX no registrada en la configuración de la plataforma." },
  "Efetue o PIX no valor acordado com seu provedor.": { es: "Realice el PIX por el valor acordado con su proveedor." },
  "Envie o comprovante para liberação ou extensão da data de validade.": { es: "Envíe el comprobante para liberación o extensión de la fecha de validez." },
  "Falar com o Financeiro no WhatsApp": { es: "Hablar con Finanzas por WhatsApp" },
  "Dúvidas financeiras?": { es: "¿Dudas financieras?" },
  "Preencha todos os campos.": { es: "Llene todos los campos." },
  "Conexão salva com sucesso!": { es: "¡Conexión guardada con éxito!" },
  "Erro ao salvar conexão.": { es: "Error al guardar conexión." },
  "Preencha todos os campos antes de testar.": { es: "Llene todos los campos antes de probar." },
  "Conexão bem-sucedida!": { es: "¡Conexión exitosa!" },
  "Falha no teste de conexão.": { es: "Falla en la prueba de conexión." },
  "Configure integrações com serviços externos para sua organização.": { es: "Configure integraciones con servicios externos para su organización." },
  "Supabase Externo": { es: "Supabase Externo" },
  "Conecte um banco Supabase externo para sincronizar dados adicionais.": { es: "Conecte una base de datos Supabase externa para sincronizar datos adicionales." },
  "URL do Supabase Externo": { es: "URL de Supabase Externo" },
  "API Key (Service Role ou Anon)": { es: "API Key (Service Role o Anon)" },
  "Salvar Configuração": { es: "Guardar Configuración" },
  "Testando...": { es: "Probando..." },
  "Testar Conexão": { es: "Probar Conexión" },
  "Convite indisponível": { es: "Invitación no disponible" },
  "Ir para o painel": { es: "Ir al panel" },
  "Aprovar tenant": { es: "Aprobar tenant" },
  "Aprovando...": { es: "Aprobando..." },
  "Vencimento": { es: "Vencimiento" },
  "Assinatura atualizada com sucesso!": { es: "¡Suscripción actualizada con éxito!" },
  "Falha ao atualizar assinatura.": { es: "Error al actualizar suscripción." },
  "Gestão de Assinatura (SaaS)": { es: "Gestión de Suscripción (SaaS)" },
  "Plano atual:": { es: "Plan actual:" },
  "Validade:": { es: "Validez:" },
  "Prazo restante:": { es: "Plazo restante:" },
  "Prorrogação Rápida": { es: "Prórroga Rápida" },
  "Alterar Plano": { es: "Cambiar Plan" },
  "Data Específica de Vencimento": { es: "Fecha Específica de Vencimiento" },
  "Remover expiração (tornar vitalício)": { es: "Eliminar expiración (hacer vitalicio)" },
  "O recurso ": { es: "El recurso " },
  " não está disponível no seu plano atual": { es: " no está disponible en su plan actual" },
  "Fazer Upgrade de Plano": { es: "Hacer Upgrade de Plan" },
  "Voltar ao Início": { es: "Volver al Inicio" },
  "Sua assinatura expira hoje!": { es: "¡Su suscripción expira hoy!" },
  "Sua assinatura expira amanhã!": { es: "¡Su suscripción expira mañana!" },
  "Sua assinatura expira em": { es: "Su suscripción expira en" },
  "dias.": { es: "días." },
  "Efetue a renovação para manter o acesso ininterrupto.": { es: "Realice la renovación para mantener el acceso ininterrumpido." },
  "Ver dados para PIX": { es: "Ver datos para PIX" },
  "Chave PIX copiada com sucesso!": { es: "¡Clave PIX copiada con éxito!" },
  "Copiar chave PIX": { es: "Copiar clave PIX" },
  "Organização aguardando aprovação": { es: "Organización esperando aprobación" },
  "Este tenant não poderá ser acessado até que seja aprovado pelo master admin.": { es: "Este tenant no podrá ser accedido hasta que sea aprobado por el master admin." },
  "O desempenho das campanhas que estão trazendo gente para cá.": { es: "El desempeño de las campañas que están trayendo gente aquí." },
  "Conecte um token de acesso para o sistema ler o desempenho das suas campanhas e mostrá-lo ": { es: "Conecte un token de acceso para que el sistema lea el desempeño de sus campañas y lo muestre " },
  "O que se pode marcar, quanto dura e quem atende. É isto que a tela de marcar e o agente de": { es: "Lo que se puede marcar, cuánto dura y quién atiende. Es esto lo que la pantalla de marcar y el agente de" },
  "Venda no automático.": { es: "Venda en automático." },
  "O CRM inteligente que atende seus clientes 24h por dia no WhatsApp, entende o que eles buscam e já prepara tudo para você fechar a venda.": { es: "El CRM inteligente que atiende a sus clientes 24h al día en WhatsApp, entiende lo que buscan y ya prepara todo para que cierre la venta." },
  "Começar Agora": { es: "Empezar Ahora" },
  "Sem Latência": { es: "Sin Latencia" },
  "Respostas instantâneas integradas diretamente ao seu número, sem intermediários caros.": { es: "Respuestas instantáneas integradas directamente a su número, sin intermediarios caros." },
  "Pronto para clínicas, escolas, imobiliárias ou e-commerce. A IA se adapta perfeitamente ao seu negócio.": { es: "Listo para clínicas, escuelas, inmobiliarias o e-commerce. La IA se adapta perfectamente a su negocio." },
  "Segurança Total": { es: "Seguridad Total" },
  "Self-hosted e LGPD-first. Você é dono dos seus dados e das conversas dos seus clientes.": { es: "Self-hosted y LGPD-first. Usted es dueño de sus datos y de las conversaciones de sus clientes." },
  "Escolha um nicho abaixo e converse com nosso agente de demonstração. Descubra como ele qualifica leads e agenda atendimentos naturalmente.": { es: "Elija un nicho abajo y converse con nuestro agente de demostración. Descubra cómo califica leads y agenda atenciones naturalmente." },
  "Pronto para escalar seu atendimento?": { es: "¿Listo para escalar su atención?" },
  "Você atingiu o limite de mensagens para esta demonstração. Crie sua conta para testar mais!": { es: "Ha alcanzado el límite de mensajes para esta demostración. ¡Cree su cuenta para probar más!" },
  "Ambiente de Sandbox - As mensagens não são salvas no sistema.": { es: "Entorno de Sandbox - Los mensajes no se guardan en el sistema." },
