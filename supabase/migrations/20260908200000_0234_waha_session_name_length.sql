-- =============================================================================
-- Migration 0234: Adequação do tamanho do waha_session_name (<= 54 caracteres)
-- =============================================================================
...
-- A migration 0230 gerava 'org_' (4) + org_uuid_no_hyphens (32) + '_' (1) +
-- uuid_no_hyphens (32) = 69 caracteres, o que causava waha_create_400 no Waha.
--
-- Esta migration:
-- 1. Encurta registros legados em channel_sessions com tamanho > 54 para 54 caracteres.
-- 2. Atualiza fn_reserve_channel_connection para gerar 49 caracteres:
--    'org_' (4) + org_uuid_no_hyphens (32) + '_' (1) + uuid_random_12 (12) = 49 chars.
-- =============================================================================

update public.channel_sessions
   set waha_session_name = left(waha_session_name, 54)
...
begin
 ...
 if found then
  ...
  if channel.id is null then
   -- Nome com 49 caracteres (org_ + 32 hex org + _ + 12 hex aleatórios), estritamente abaixo do teto de 54 do WAHA
   ...
   values(p_org,'org_'||replace(p_org::text,'-','')||'_'||left(replace(gen_random_uuid()::text,'-',''),12),p_display_name,'NOWEB',
